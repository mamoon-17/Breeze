  ...
  head: () => ({
    meta: [
      ...
      { title: "Breeze — calm, AI-powered messaging" },
      {
        name: "description",
        content:
          "Breeze is an AI-powered messaging and calling platform. A smart agent acts on your behalf, summarizes chats, and enhances every reply.",
      },
      { name: "author", content: "Breeze" },
      { property: "og:title", content: "Breeze — calm, AI-powered messaging" },
      {
        property: "og:description",
        content:
          "Real-time chat with an AI agent that summarizes, enhances, and replies on your behalf.",
      },
